...
// import "../CSS/FrontEndTrainingOfferOffer.css";
...
// const FrontEndTrainingOfferDetailPage = () => {
...
//                 </div>
//                 <div className='FrontEndTrainingOfferImgWrap'>
//                     <img src={TrainingPic1} alt="Website" />
//                 </div>
//                 <div className='FrontEndTrainingOfferBody'>
//                     <div className='FrontEndTrainingOfferBodyRight FrontEndTrainingOfferOfferBodyRight'>
...
//                             <div className='FrontEndTrainingOfferformNote'>
...
// export default FrontEndTrainingOfferDetailPage;
...
import React, { useContext, useEffect, useState } from 'react';
// import "../CSS/FrontEndTrainingOfferOffer.css";
import "../CSS/FrontEndTrainingDetailPage.css"
import WebsiteImg from "../Images/Homehub screenshots.4d6cb57dadef51c1c906.png";
import axios from 'axios';
import Swal from 'sweetalert2';
import { FaBackward } from 'react-icons/fa6';
...
const FrontEndTrainingOfferDetailPage = () => {
    ...
    const [isChecked, setIsChecked] = useState(false);
    const [isCheckedError, setIsCheckedError] = useState("");
    const [formData, setFormData] = useState({orderName:"Front End Web Development Training",
    fullName: "", email: "", phoneNumber: "", confirmPhoneNumber: "", address: "", 
});
                ...
                <div className='FrontEndTrainingOfferBody'>
                    ...
                    <div className='FrontEndTrainingOfferBodyLeft'>
                        ...
                        {/* <div className='TextAreaWrap'>
                            ...
                            {openSubmit&&
                            <div className='FrontEndTrainingOfferFormSubmitUiWrap'>
                                <div className='FrontEndTrainingOfferFormSubmitUi'>
